...
const GenderSelect = () => {
    return (
        <>
            <div className="flex items-center gap-4 overflow-hidden rounded-md px-6 py-3 shadow-sm border">
                <span className="text-center text-base font-semibold capitalize text-neutral-600">
                    Giới tính
                </span>
