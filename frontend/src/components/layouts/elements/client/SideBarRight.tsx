...
const SideBarRight = () => {
  return (
    <Sider width={240} className="sidebarright h-screen px-[20px] bg-white border-l-[1px] right-0 overflow-y-scroll scrollbar-hide absolute hidden md:sticky translate-x-full md:translate-x-0 z-[100] md:block">
